...
public class HizmetliSecim extends javax.swing.JFrame {

    public HizmetliSecim() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Hizmetli Ekle");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 83, 172, 52));

        jButton2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/arkaplanveiconlar/güncelle icon.png"))); // NOI18N
        jButton2.setText("Hizmetli Güncelle Veya Sil");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 83, -1, 52));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 250, 100, 49));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/arkaplanveiconlar/secim ekrani.jpg"))); // NOI18N
